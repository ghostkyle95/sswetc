...
function sh_setcharacter()
{
	if argument0[1] != undefined
	{
		...
		else if argument0[1] == "N"
		{
			obj_player.character = CHARACTERS.PIZZANO;
			obj_player.doisemode = false;
		}
		else if argument0[1] == "G"
		{
			obj_player.character = CHARACTERS.GUMBOB;
			obj_player.doisemode = false;
		}
		else if argument0[1] == "NS"
		{
			obj_player.character = CHARACTERS.NOISE;
			obj_player.doisemode = false;
		}
		else if argument0[1] == "DS"
		{
			obj_player.character = CHARACTERS.NOISE;
			obj_player.doisemode = true;
		}
		else if argument0[1] == "SW"
		{
			obj_player.character = CHARACTERS.SWAB;
			obj_player.doisemode = false;
		}
		else if argument0[1] == "NIK"
		{
			obj_player.character = CHARACTERS.NIKOCADO;
			obj_player.doisemode = false;
		}
	}
}
function meta_setcharacter()
{
	return 
	{
		...
		arguments: ["<character>"],
		suggestions: [["P", "N", "G", "NS", "DS", "SW", "NIK"]],
		argumentDescriptions: ["character"]
	};
}
