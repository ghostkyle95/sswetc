...
{
	if (image_index >= (image_number - 1) && sprite_index == spr_gumbob_brew_pulloutdrink)
		sprite_index = spr_gumbob_brew_shake;
	if (image_index >= (image_number - 1) && sprite_index == spr_gumbob_brew_shake)
		state = states.normal;
	...
	if (image_index >= (image_number - 1) && sprite_index == spr_gumbob_brew_up)
	{
		state = states.normal;
